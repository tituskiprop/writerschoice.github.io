...
<html>
<head>
<title> Sign Up Writers Choice</title>
...
<div class="container">
  <div class="row">
    <div class="col-sm-4">
     ...
     <div class="col-sm-4">
      <img src="mz.jpg" alt="Techno Smarter" class="logo img-fluid"> 
    </div>
     <div class="col-sm-4">
    </div>
  </div>
...
?>
      ...
      <?php if(isset($done)) 
      { ?>
    <div class="successmsg"><span style="font-size:100px;">&#9989;</span> <br> <i>Registered successfully . </i><br> <a href="login.php" style="color:forestgreen;" >Click here to Login... </a> </div>
      <?php } else { ?>
